      ...
      <div>
        <div className={`flex ${expand ? "flex-row gap-10" : "flex-col items-center gap-8"}`}>
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-8 w-8 aspect-square rounded-lg cursor-pointer"
          >
            <Image src={assets.menu_icon} alt="Menu Icon" className="md:hidden" />
            <Image src={expand ? assets.sidebar_close_icon : assets.sidebar_icon} alt="Toggle Sidebar" className="hidden md:block w-7" />
